...
export default function InputField({ onFileChange }: InputFieldProps) {
  ...
  return (
    <section
      className={cn(
        "relative flex h-full w-full cursor-pointer flex-col items-center justify-center rounded-xl border-2 border-dashed bg-blue-700/10 px-6 py-8 shadow-lg transition",
